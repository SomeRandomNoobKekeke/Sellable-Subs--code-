...
namespace SellableSubs
{
  public partial class Plugin : IAssemblyPlugin
  {
    public static bool SubmarineSelection_CreateGUI_Replace(SubmarineSelection __instance)
    {
      ...
      if (!Mod.mixins.ContainsKey(_)) Mod.mixins[_] = new SubmarineSelectionMixin();
      ...
      Mod.mixins[_].bottomContainer = bottomContainer;
      ...
      Mod.mixins[_].sellButton = new GUIButton(
        new RectTransform(
      ...
      //transferInfoFrameWidth -= Mod.mixins[_].sellButton.RectTransform.RelativeSize.X;
      ...
      Mod.mixins[_].sellCurrentTickBox = new GUITickBox(
        new RectTransform(
      ...
      //transferInfoFrameWidth -= Mod.mixins[_].sellCurrentTickBox.RectTransform.RelativeSize.X;
